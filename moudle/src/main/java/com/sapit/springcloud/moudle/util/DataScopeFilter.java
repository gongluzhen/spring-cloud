package com.sapit.springcloud.moudle.util;
...
public class DataScopeFilter {
	 ...
	 */
	public static void dataScopeFilter(User user, BaseEntity<?> entity, String sqlMapKey, String officeWheres, String userWheres) {
		// 如果是超级管理员，则不过滤数据
		if (user.isAdmin()) {
			return;
		}
