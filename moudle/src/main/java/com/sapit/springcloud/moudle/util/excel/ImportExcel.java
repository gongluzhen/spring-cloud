package com.sapit.springcloud.moudle.util.excel;
...
import com.sapit.springcloud.moudle.util.excel.groups.Group;
...
public class ImportExcel {
	 ...
	 *            导入分组
	 */
	public <E> List<E> getDataList(Class<E> cls, Group... groups) throws InstantiationException, IllegalAccessException {
			...
			for (Object[] os : annotationList) {
				...
				if (val != null) {
					...
					if (StringUtils.isNotBlank(ef.dictType())) {
						val = Reflections.invokeMethodOnClass("com.sapit.springcloud.web.common.utils.DictUtils", "getDictValue",
								new Class[] { String.class, String.class, String.class }, new String[] { val.toString(), ef.dictType(), ef.dictDefaultValue() });
						log.debug("Dictionary type value: [" + i + "," + column + "] " + val);
					}
					...
					try {
						...
						log.info("Get cell value [" + i + "," + column + valType + "] error: " + ex.toString());
						val = null;
					}
					// set entity value
					if (os[1] instanceof Field) {
