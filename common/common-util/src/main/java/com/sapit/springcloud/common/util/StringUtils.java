...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	public static boolean isCheckboxChecked(String values, String value){
		if(isBlank(values) || isBlank(value)){
			return false;
		}
		String[] array = split(values, ",");
	...
	public static void main(String[] args) {
		System.out.println(isCheckboxChecked("1,0", "1"));
	}
}
