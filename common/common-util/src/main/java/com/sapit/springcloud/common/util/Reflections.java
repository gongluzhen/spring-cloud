...
public class Reflections {
	...
	public static Object invokeMethodOnClass(final String className, final String methodName, final Class<?>[] parameterTypes, final Object[] args) {
		...
		try {
			...
			if (method == null) {
				throw new IllegalArgumentException("Could not find method [" + methodName + "] on target [" + cls + "]");
			}
