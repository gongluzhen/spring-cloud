...
function businessIntegration_1_1() {
...
function businessIntegration_1_2() {
    $.jBox('id:id-html', { bottomText: '这是底部文字' });
}
function businessIntegration_1_3() {
    $.jBox("get:ajax.html");
}
function businessIntegration_1_4() {
...
function businessIntegration_1_5() {
    var content = {
        state1: {
            content: '状态一',
            buttons: { '下一步': 1, '取消': 0 },
...
function businessIntegration_1_6() {
...
function businessIntegration_2_1() {
    $.jBox.open("iframe:http://www.baidu.com", "百度一下", 800, 350, { buttons: { '关闭': true} });
}
function businessIntegration_2_2() {
...
function businessIntegration_3_1() {
    //加了个其它参数closed
    $.jBox.prompt('Hello jBox', 'jBox', 'info', { closed: function () { alert('prompt is closed.'); } });
}
function businessIntegration_3_2() {
    $.jBox.alert('Hello jBox', 'jBox');
}
function businessIntegration_3_3() {
    $.jBox.info('Hello jBox', 'jBox');
}
function businessIntegration_3_4() {
    $.jBox.success('Hello jBox', 'jBox');
}
function businessIntegration_3_5() {
    $.jBox.error('Hello jBox', 'jBox');
}
function businessIntegration_3_6() {
    var submit = function (v, h, f) {
        if (v == 'ok')
            jBox.tip(v, 'info');
        else if (v == 'cancel')
...
function businessIntegration_3_6_2() {
    var submit = function (v, h, f) {
        if (v == true)
            jBox.tip("恩", 'info');
        else
...
function businessIntegration_3_7() {
    var submit = function (v, h, f) {
        if (v == 'yes') {
...
function businessIntegration_5_1() {
    $.jBox.messager('Hello jBox', 'jBox');
}
function businessIntegration_5_2() {
    $.jBox.messager("Hello jBox 2", "my title", null, { width: 350, showType: 'fade' });
}
function businessIntegration_5_3() {
