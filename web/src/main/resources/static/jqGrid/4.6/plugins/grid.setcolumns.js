			...
			if ( $("#"+IDs.themodal).html() != null ) {
				...
				if(!p.updateAfterCheck) {
					$("#dData","#"+dtbl+"_2").click(function(e){
						...
						if(p.closeAfterSubmit) $.jgrid.hibusinessIntegrationdal("#"+IDs.themodal,{gb:"#gbox_"+gID,jqm:p.jqModal, onClose: p.onClose});
				...
				$("#eData", "#"+dtbl+"_2").click(function(e){
					$.jgrid.hibusinessIntegrationdal("#"+IDs.themodal,{gb:"#gbox_"+gID,jqm:p.jqModal, onClose: p.onClose});
					return false;
				});
