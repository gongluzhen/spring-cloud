package com.sapit.springcloud.web.common.shiro.session;
...
import com.sapit.springcloud.common.redis.JedisUtils;
...
public class JedisSessionDAO extends AbstractSessionDAO implements SessionDAO {
	...
	public void update(Session session) throws UnknownSessionException {
		...
		if (request != null){
			...
			// 手动控制不更新SESSION
			if (Constants.NO.equals(request.getParameter("updateSession"))){
				return;
			}
		}
